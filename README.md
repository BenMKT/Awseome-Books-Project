...
To run the project, open index.html in your local browser
...
Feel free to check the [issues page](https://github.com/BenMKT/Awseome-Books-Project/issues).
...
If you like this project rate a ⭐️!...
...
I would like to thank the [Microverse](https://www.microverse.org/) community.
